  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <h1 className="text-3xl font-bold font-outfit text-gray-900 mb-8">Order History</h1>
        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-4">
            {orders.map((order) => (
              <div 
                key={order.id}
                className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:border-blue-200 transition-all group cursor-pointer"
              >
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-gray-50 rounded-xl group-hover:bg-blue-50 transition-colors">
                      <Package className="h-6 w-6 text-gray-400 group-hover:text-blue-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-900">Order #{String(order.id).padStart(5, '0')}</h3>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-400 uppercase tracking-wider">{order.payment_method}</p>
                    </div>
