...
import { Lock, Phone, User, Building2, Mail, AtSign, Eye, EyeOff } from "lucide-react";
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                placeholder="••••••••"
