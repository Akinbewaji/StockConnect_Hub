    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          <div 
            key={customer.id} 
            className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm cursor-pointer hover:border-indigo-200 transition-colors"
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="text-right">
                <span className="block text-xs font-medium text-slate-500 uppercase">Loyalty Points</span>
          ...
          <div className="bg-white w-full max-w-2xl rounded-2xl p-6 space-y-6 max-h-[90vh] flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-slate-50 p-4 rounded-xl">
                ...
                <span className="text-sm font-semibold text-slate-900">{selectedCustomer.phone}</span>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl">
                <span className="block text-xs font-medium text-slate-500 uppercase">Email</span>
                <span className="text-sm font-semibold text-slate-900">{selectedCustomer.email || 'N/A'}</span>
              </div>
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {selectedCustomer.orders.map((order: any) => (
                        <tr key={order.id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-4 py-4 text-right font-bold text-slate-900">₦{order.total_amount.toLocaleString()}</td>
