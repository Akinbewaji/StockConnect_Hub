    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Manage customer points and redemptions</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500">Redemptions This Month</p>
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500">Top Customer Points</p>
              <h3 className="text-2xl font-bold text-slate-900">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-slate-100">
          {filteredCustomers.map((customer) => (
            <div key={customer.id} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-6">
                <div className="text-right">
                  <p className="text-xs text-slate-500 uppercase font-medium">Balance</p>
                ...
                <button
                  ...
                  className="bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-50 flex items-center gap-2"
                >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-2xl p-6 space-y-6">
            <div className="text-center">
              ...
              <p className="text-slate-500">for {selectedCustomer.name}</p>
            </div>
              ...
              <form onSubmit={handleRedeemPoints} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-lg font-medium text-center"
